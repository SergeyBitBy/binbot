...
class MonitoringService:
    ...
    def _payload(profile, merchant, contacts, item) -> dict:
        ...
        return {
            ...
            "min_amount": str(item.adv.minSingleTransAmount) if item.adv.minSingleTransAmount is not None else "",
            "max_amount": str(item.adv.maxSingleTransAmount) if item.adv.maxSingleTransAmount is not None else "",
